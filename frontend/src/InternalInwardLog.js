...
import './InternalInwardLog.css';

const InternalInwardLog = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [searchCriteria, setSearchCriteria] = useState('ID');
  const [isRelatedOutward, setIsRelatedOutward] = useState(false);
  const [viewPendingDocs, setViewPendingDocs] = useState(false);
  ...
  const handleBackToMain = () => {
    navigate('/main'); // Redirects to the Main.js component
  };

  return (
    <div className="internal-inward-log">
      <h2>Internal Inward Log Management</h2>
      ...
      <div className="search-section">
        ...
        <div className="checkboxes">
          ...
          <label>
            ...
            /> 
            Click to view pending documents
          </label>
        </div>
